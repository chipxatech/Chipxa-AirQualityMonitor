/*
  APM10 Particulate Matter Sensor - ESP8266 Standalone Demo
  ---------------------------------------------------------
  ...
  Wiring (UART Mode):
  - Sensor TX -> D5 (GPIO14 Software RX)
  - Sensor RX -> D6 (GPIO12 Software TX)
*/
...
// ESP8266: Use SoftwareSerial on D5 & D6
SoftwareSerial swSerial(D5, D6); // RX (D5), TX (D6)
#endif
...
void setup() {
    ...
    Serial.println(F("===================================="));
    Serial.println(F("APM10 PM Sensor Demo - ESP8266"));
    Serial.print(F("Mode: "));
    Serial.println(USE_I2C ? F("I2C") : F("UART (SoftwareSerial D5/D6)"));
    Serial.println(F("===================================="));
