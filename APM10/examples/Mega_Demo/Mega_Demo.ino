/*
  APM10 Particulate Matter Sensor - Mega 2560 Standalone Demo
  -----------------------------------------------------------
...
void setup() {
    ...
    Serial.println(F("===================================="));
    Serial.println(F("APM10 PM Sensor Demo - Mega 2560"));
    Serial.print(F("Mode: "));
    Serial.println(USE_I2C ? F("I2C") : F("UART (Serial1 Pin 18/19)"));
    Serial.println(F("===================================="));
...
#else
    Serial1.begin(1200);
    if (pmSensor.beginUART(Serial1)) {
        Serial.println(F("APM10 initialized via Serial1."));
    } else {
