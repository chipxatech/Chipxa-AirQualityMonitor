/*
  APM10 Particulate Matter Sensor - STM32 Standalone Demo
  -------------------------------------------------------
  ...
  Wiring (UART Mode):
  - Sensor TX -> PB11 (USART3 RX)
  - Sensor RX -> PB10 (USART3 TX)
*/
...
#if !USE_I2C
// STM32: Use HardwareSerial USART3
HardwareSerial SensorSerial(USART3);
#endif
...
void setup() {
    ...
    Serial.println(F("===================================="));
    Serial.println(F("APM10 PM Sensor Demo - STM32"));
    Serial.print(F("Mode: "));
    Serial.println(USE_I2C ? F("I2C") : F("UART (USART3)"));
    Serial.println(F("===================================="));

#if USE_I2C
    // STM32 Custom I2C Pins configuration
    Wire.setSCL(PB6);
    Wire.setSDA(PB7);
    Wire.begin();
    ...
    if (pmSensor.beginUART(SensorSerial)) {
        Serial.println(F("APM10 initialized via UART (USART3)."));
    } else {
